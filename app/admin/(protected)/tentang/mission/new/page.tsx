...
export const metadata: Metadata = {
  ...pageMetadata({
    title: "Tambah Misi",
    description: "Tambah misi Karang Taruna.",
    path: "/admin/tentang/mission/new",
  }),
  robots: {
    index: false,
    follow: false,
    ...
    <div>
      ...
      <div className="mt-4">
        ...
        <p className="mt-2 max-w-2xl text-muted-foreground">
          Tambahkan misi baru yang akan ditampilkan pada halaman Tentang.
        </p>
      </div>
